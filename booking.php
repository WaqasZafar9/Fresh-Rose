          ...
          <div class="row align-items-center">
            <div class="col-6 col-xl-2" data-aos="fade-down">
              <h1 class="mb-0">
                <a href="index.html" class="text-black h2 mb-0"
                  >Fresh <span style="color: red">Rose</span></a
                >
              </h1>
            </div>
            ...
            <div class="col-6 col-xl-2 text-right" data-aos="fade-down">
              <div class="d-none d-xl-inline-block">
                ...
                >
                  <li>
                    <a href="#" class="pl-0 pr-3 text-black"
              ...
              <form class="p-5 bg-white" name="Bookings">
                ...
                <div class="row form-group">
                  <div class="col-md-4 mb-3 mb-md-0">
                    <label class="text-black" for="country-code"
                      >Country Code</label
                    >
                    <select
                      name="Country Code"
                  ...
                  <div class="col-md-8 mb-3 mb-md-0">
                    <label class="text-black" for="whatsapp"
      ...
      <footer class="site-footer">
        <div class="container">
          ...
          <div class="row pt-5 mt-5 text-center">
            <div class="col-md-12">
              <div class="mb-5">
                <a href="https://www.facebook.com" class="pl-0 pr-3"
                  ><span class="icon-facebook"></span
                ></a>
                <a href="https://www.twitter.com" class="pl-3 pr-3"
                  ><span class="icon-twitter"></span
                ></a>
                <a
                  href="https://www.instagram.com/freshrosesalon?utm_source=qr&igsh=MWc3ZHJkdmh2b2Zraw=="
                  class="pl-3 pr-3"
                  ><span class="icon-instagram"></span
                ></a>
                <a href="https://www.linkedin.com" class="pl-3 pr-3"
    ...
    <script>
      ...
      function sendToWhatsapp(
        ...
        const message = encodeURIComponent(
          `🌹 *𝐅͟𝐫͟𝐞͟𝐬͟𝐡͟ ͟𝐑͟𝐨͟𝐬͟𝐞͟ ͟𝐁͟𝐨͟𝐨͟𝐤͟𝐢͟𝐧͟𝐠͟ ͟𝐅͟𝐨͟𝐫͟𝐦͟* 🌹\n\n🌿 *𝙉𝙚𝙬 𝙗𝙤𝙤𝙠𝙞𝙣𝙜 𝙖𝙡𝙚𝙧𝙩:*\n\n` +
